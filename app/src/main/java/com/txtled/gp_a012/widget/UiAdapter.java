...
public class UiAdapter {
    // 竖屏文件的输出路劲D:\Android\2016_6\GP382\app\src\main\res
    private final static String rootPathPort = "/D:/Android/2016_6/GP382/app/src/main/res/values-port-{0}dpi-{1}x{2}/";
    // 横屏文件的输出路劲
    private final static String rootPathLand = "/F:/studio/";
    // 水平方向（X）的值
